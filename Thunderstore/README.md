# Description:
This mod adds an RPG-like system of levels and attribute increases: - Wacky Branch 1.9.47
...
<details><summary>Mob Data Included</summary>
	...
	Latest Update for Jsons config is <b> 1.9.47 </b>(Number will be updated when Jsons recieve an update)
